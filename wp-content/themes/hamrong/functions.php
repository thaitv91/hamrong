...
function masterScripts() {
        wp_enqueue_script( 'masterslider', get_stylesheet_directory_uri() . '/js/masterslider/masterslider.min.js', array('jquery') );
        wp_enqueue_script( 'prettyPhoto', get_stylesheet_directory_uri() . '/js/masterslider/jquery.prettyPhoto.js', array('jquery') );
        wp_enqueue_script( 'lightboxjs', get_stylesheet_directory_uri() . '/js/lightbox/lightbox.js', array('jquery') );
        wp_enqueue_script( 'master-option', get_stylesheet_directory_uri() . '/js/masterslider/script.js', array('jquery') );
        wp_enqueue_style( 'masterslider-css', get_stylesheet_directory_uri() . '/css/masterslider/masterslider.main.css');
        wp_enqueue_style( 'lightbox-css', get_stylesheet_directory_uri() . '/css/lightbox/lightbox.css');
}
...
function admin_css() {
	wp_enqueue_style( 'admin-css', get_stylesheet_directory_uri() . '/css/admin-style.css');
}

add_action( 'admin_bar_menu', 'toolbar_link_to_email', 999 );

function toolbar_link_to_email( $wp_admin_bar ) {
	$args = array(
		'id'    => 'all-email',
		'title' => 'All Email',
		'href'  => 'http://thaitranblog.com/hamrong/wp-admin/admin.php?page=CF7DBPluginSubmissions',
		'meta'  => array( 'class' => 'my-toolbar-email' )
	);
